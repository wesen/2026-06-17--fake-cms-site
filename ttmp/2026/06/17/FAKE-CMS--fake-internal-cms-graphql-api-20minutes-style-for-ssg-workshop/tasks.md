...
- [ ] P0.1 Init go module (github.com/go-go-golems/fake-cms), create Makefile, .gitignore (done), README stub
- [ ] P0.2 Add deps: glazed, graphql-go/graphql, modernc.org/sqlite; pin go.mod; go mod tidy
- [ ] P0.3 Scaffold package dirs: internal/{domain,repo,graphql,server,cli}, cmd/fake-cms, migrations, testdata
- [ ] P0.4 Root cobra command (fake-cms) wired via glazed; --help lists serve/seed/db
